...
const CoinsTable = ({ state, price }) => {
  ...
  return (
    <div>
      <section className="mx-4 md:mx-10 mb-10 pt-5">
        {/* search start */}
        <form className="">
          <label
            for="default-search"
          ...
          <div class="relative">
            ...
            <button
              type="submit"
              class="text-white absolute right-2.5 bottom-2.5 bg-yellow-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-yellow-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto w-full text-sm bg-white rounded-xl my-5">
